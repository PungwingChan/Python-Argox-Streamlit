...
UUID = os.environ.get('UUID', 'dc4a7c23-7d4a-2cde-312c-0e1752c8c59c')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nezha.9logo.eu.org:443')      # 哪吒面板域名或ip, v1格式: nezha.xxx.com:8008, v0格式: nezha.xxx.com
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')          # v1哪吒请留空, v0哪吒的agent通信端口,自动匹配tls
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'c0FdihFZ8XpqXFbu7muAAPkD5JmeVY4g')            # v1哪吒的NZ_CLIENT_SECRET或v0哪吒agent密钥
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'streamlit-us.cyberangel.dpdns.org')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNGMyMGE2ZTY0MmM4YWZhNzMzZDRlYzY0N2I0OWRlZTQiLCJ0IjoiMjNhNzE5YjgtOGMwZi00ZmZjLTk5YmItZGM5MWFhYWYwODNlIiwicyI6Ik9EQXlNbVJoWm1RdE5ESTJPUzAwWWpneUxXRmhabUV0WlRJNVlXVmtZamhsTm1KayJ9')            # Argo固定隧道密钥,留空即使用临时隧道
ARGO_PORT = int(os.environ.get('ARGO_PORT', '9010'))   # Argo端口,使用固定隧道token需在cloudflare后台设置端口和这里一致
